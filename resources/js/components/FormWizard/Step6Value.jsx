                ...
                <div className="row ">
                    <div className="col-8 d-flex flex-column personal-detail-label true-false-label">
                        ...
                        <div className="responsive-radio-sec d-none">
                            <input type="radio" class="form-check-input" name="RadioDefault1" />
                            <label className="form-label" for="flexRadioDefault1">Yes</label>
                            <input type="radio" class="form-check-input" name="RadioDefault1" />
                            <label className="form-label" for="flexRadioDefault1">No</label>
                        </div>
